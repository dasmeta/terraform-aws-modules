...
| Name | Description |
|------|-------------|
| <a name="output_accelerator_arn"></a> [accelerator\_arn](#output\_accelerator\_arn) | ARN of the planned example accelerator. |
| <a name="output_dns_name"></a> [dns\_name](#output\_dns\_name) | DNS name of the planned example accelerator. |
...
| <a name="output_hosted_zone_id"></a> [hosted\_zone\_id](#output\_hosted\_zone\_id) | Route 53 hosted zone ID of the planned example accelerator. |
| <a name="output_ip_sets"></a> [ip\_sets](#output\_ip\_sets) | IP sets assigned to the planned example accelerator. |
