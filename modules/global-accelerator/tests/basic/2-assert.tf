output "accelerator_arn" {
  description = "ARN of the planned example accelerator."
  value       = module.global_accelerator.accelerator_arn
}

output "dns_name" {
  description = "DNS name of the planned example accelerator."
...
output "hosted_zone_id" {
  description = "Route 53 hosted zone ID of the planned example accelerator."
  value       = module.global_accelerator.hosted_zone_id
}

output "ip_sets" {
  description = "IP sets assigned to the planned example accelerator."
