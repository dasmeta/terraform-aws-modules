...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cmdb"></a> [cmdb](#module\_cmdb) | ./cmdb-integration | n/a |
...
| <a name="input_enable_cmdb_integration"></a> [enable\_cmdb\_integration](#input\_enable\_cmdb\_integration) | Enable cmdb integration | `bool` | `true` | no |
