...
| <a name="module_ssl-certificate-auth"></a> [ssl-certificate-auth](#module\_ssl-certificate-auth) | git::https://github.com/dasmeta/terraform-aws-modules.git//modules/ssl-certificate | DMVP-fix-cert |
