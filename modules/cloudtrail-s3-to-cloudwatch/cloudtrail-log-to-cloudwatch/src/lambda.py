...
def parse_iso8601(string):
    """
    Parses a string such as 2020-01-15T12:29:59Z
...
def read_log_entries(bucket, key):
    with NamedTemporaryFile() as temp_file:
        ...
        with gzip.open(temp_file.name, 'r') as extracted_file:
    ...
    for record in event["Records"]:
        ...
        for data in my_data:
            ...
            if "CloudTrail/" in key:
                times = data['Records']
                timestamp = times[0]['eventTime']
            else:
                timestamp =  data['digestStartTime']
