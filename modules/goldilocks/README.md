...
| <a name="input_auth"></a> [auth](#input\_auth) | n/a | <pre>object({<br>    userPoolARN      = string,<br>    userPoolClientID = string,<br>    userPoolDomain   = string<br>  })</pre> | <pre>{<br>  "userPoolARN": "",<br>  "userPoolClientID": "",<br>  "userPoolDomain": ""<br>}</pre> | no |
